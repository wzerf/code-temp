...
- Prefers all model capabilities (including image generation) to be configured centrally in model management rather than per-feature configuration. Confidence: 0.8
